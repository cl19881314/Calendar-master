...
public class CalendarUtils {
    ...
    private Map<String,  ArrayList<WorkTypeBean>> sMonthTaskHint = new HashMap<>();
    ...
    public ArrayList<WorkTypeBean> removeTaskHints(int year, int month, List<Integer> days) {
        String key = hashKey(year, month);
        ArrayList<WorkTypeBean> hints = sUtils.sMonthTaskHint.get(key);
        if (hints == null) {
            hints = new ArrayList<>();
    ...
    public ArrayList<WorkTypeBean> getTaskHints(int year, int month) {
        String key = hashKey(year, month);
        ArrayList<WorkTypeBean> hints = sUtils.sMonthTaskHint.get(key);
        if (hints == null) {
            hints = new ArrayList<>();
